      ...
      { "<leader>nf", "<cmd>ZkNotes<cr>", desc = "ZK Notes" },
      {
        ...
        function()
          ...
          if computer_name == "VTMACMKXYVH42WL" then
            zk_notes_dir = "~/code/personal/github.com/ndland/zk-notes"
          else
            zk_notes_dir = "~/code/github.com/ndland/zk-notes" -- Default path
          end
          ...
          if handle then
            ...
            print("Error: Unable to find directories")
          end
        end,
        desc = "ZK New",
      },
